...
export default class SpacingGridClass extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch(
      `https://api.openweathermap.org/data/2.5/onecall?lat=${this.state.coord[0]}&lon=${this.state.coord[0]}&%20exclude=hourly,daily&appid=f25075de1148c157d43cbd98dae55bed
